...
from unicycle_motion_control import ahc_triangle_motion_prediction


class TriangleMotionPrediction:
    def __init__(self):
    ...
    def start(self):
        ...
        rospy.init_node('triangle_motion_prediction_node', anonymous=True)
        ...
        while not rospy.is_shutdown():
            ...
            motion_prediction_polygon = ahc_triangle_motion_prediction(self.position, self.orientation, self.goal_position, self.epsilongain, self.motion_direction)
...
if __name__ == '__main__':
    try:
        triangular_motion_prediction = TriangleMotionPrediction().start()
