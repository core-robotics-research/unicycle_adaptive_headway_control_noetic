...
from unicycle_motion_control import ahc_circle_motion_prediction


class CircleMotionPrediction:
    def __init__(self):
    ...
    def start(self):
        ...
        while not rospy.is_shutdown():
            ...
            motion_prediction_polygon = ahc_circle_motion_prediction(self.position, self.orientation, self.goal_position, self.epsilongain, self.motion_direction, self.resolution)
...
if __name__ == '__main__':
    try:
        circular_motion_prediction = CircleMotionPrediction().start()
